...
public class BoardListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// BoardListServlet?Page=1 => GET (물음표 뒤에 데이터가 붙을 때)
		...
		/*
		 	...
		 	---
		 	inline 속성
		 	  <span> : 가로 분할 (부분적으로 원하는 위치에 CSS 사용)
		 	  <input> : 입력창을 가로로 출력
		 	  <img>
		 	  <a>
		 	  글자태그 : <b> , <font>
		...
		out.println("<tr>");
		out.println("<td>");
		out.println("<a href=BoardInsertServlet>새글</a>"); // 입력창
		out.println("</td>");
		out.println("</tr>");
		out.println("</table>");
		
		out.println("<table class=table_content width=800>");
		out.println("<tr hetght=35>");
