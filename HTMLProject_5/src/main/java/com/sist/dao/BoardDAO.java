...
public class BoardDAO {
	...
	/*
	 		...
	 		1. 미리 Connection 객체를 생성
	 		   => 몇개 => maxIdle=10
	 		2. 연결되어있는 Connection의 주소값을 얻어온다.
	 		3. Connection을 사용
	 		4. 사용 후에는 반드시 반환
	 		========================================
	 		1. 보안이 뛰어나다.
	 		...
	 		4. 웹 프로그램에 접근하는 인원이 많아서 쉽게 다운되지 않는다.
	 		5. 웹서버는 DBCP를 기본으로 하고있다.
	 		==> MyBatis / JPA
	...
	public void getConnection()
	{
		try 
		{
			// 저장시에 => 탐색기 형식으로 메모리 주소를 저장 JNDI (Java Naming Directory Interface)
			// c:\ . java://comp/env => jdbc/oracle
			
			// 1. 탐색기 열기
			Context init=new InitialContext();
			
			// 2. 저장된 위치 확인 (c드라이브 접근)
