	       ...
	       <table class="table">
		       <tr>
		        <td class="text-center">
		         <img src="https://www.menupan.com${vo.poster }" style="width:210px;height: 170px" title="${vo.name }">
		        </td>
		       </tr>
		       <tr>
		        <td>${vo.name }</td>
	   				...
	   				<td>
	   				  <form method="post" action="../reply/insert.do">
	   				   ...
	   				   <input type="hidden" name="cno" value="${vo.no }">
	   					...
	   					<input type="submit" value="댓글 쓰기" style="float: left;width: 100px;height: 106px;text-align: center;margin-left: 2px" class="btn-primary">
	   				  </form>
	   				</td>
	   			</tr>
	   		</table>
